...
public class ExerciseDatabase {
	...
	public long insertExercise(ExerciseEntity e) {
		...
		long ret = database.insert("ExerciseDetails", null, newExercise);
	...
	public void updateExercise(ExerciseEntity e) {
		...
		open(); // open the database
		database.update("ExerciseDetails", editExercise, "name=" + e.getName(),
				null);
		close(); // close the database
	...
	public ArrayList<ExerciseEntity> getAllExercises() {
		Cursor result = database.query("ExerciseDetails", null, null, null,
				null, null, null);
		int nameIndex;
		int calIndex;
		ExerciseEntity e1;

...
public class CaloriesChartActivity extends Activity
{
    ...
    private void updatePlot() {
        ...
        series1 = new SimpleXYSeries(Arrays.asList(series1Numbers), SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "Calories");
        ...
        if (BarRenderer.BarRenderStyle.STACKED.equals(BarRenderer.BarRenderStyle.OVERLAID)) {
